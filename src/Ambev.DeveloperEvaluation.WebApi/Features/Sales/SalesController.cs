...
namespace Ambev.DeveloperEvaluation.WebApi.Features.Sales
{
    ...
    public class SalesController : BaseController
    {
        ...
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
        public async Task<IActionResult> ListSaleByIdAsync([FromRoute] Guid id, CancellationToken cancellationToken)
        {
        ...
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
        public async Task<IActionResult> ListSaleAsync(CancellationToken cancellationToken)
        {

            var command = new ListSaleQuery();
            var response = await _mediator.Send(command, cancellationToken);
